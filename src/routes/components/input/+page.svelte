...
<Spacer h={20} />
<Snippet width="450px" type="transparent" text={`import { Input } from 'geist-ui-svelte';`} />
<Spacer h={30} />
<Text type="h4">Basic</Text>
<Spacer h={10} />
<Playground code={`<Input placeholder="Some input"/>`}>
...
<Spacer h={10} />
<Playground code={`<Input width="100%" placeholder="Some input"/>`}>

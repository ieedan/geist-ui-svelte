...
const dark: ThemeInput = {
	colors: {
		...
		"editorBracketHighlight.foreground1": "#d9d9d9",
		"editorBracketHighlight.foreground2": "#d9d9d9",
		"editorBracketHighlight.foreground3": "#4d79ff",
		"editorBracketHighlight.foreground4": "#d9d9d9",
		"editorBracketHighlight.foreground5": "#d9d9d9",
		"editorBracketHighlight.foreground6": "#4d79ff",
		"editorBracketMatch.background": "#17E5E650",
		"editorBracketMatch.border": "#17E5E600",
		"editorCursor.foreground": "#c8e1ff",
		"editorError.foreground": "#ff6166",
		...
		"gitDecoration.conflictingResourceForeground": "#d9d9d9",
		"gitDecoration.deletedResourceForeground": "#ea4a5a",
		"gitDecoration.ignoredResourceForeground": "#6a737d",
		"gitDecoration.modifiedResourceForeground": "#d9d9d9",
		...
		"notificationsInfoIcon.foreground": "#d9d9d9",
		"notificationsWarningIcon.foreground": "#d9d9d9",
		...
		"terminal.ansiBrightBlue": "#d9d9d9",
		"terminal.ansiBrightCyan": "#56d4dd",
		"terminal.ansiBrightGreen": "#4d79ff",
		"terminal.ansiBrightMagenta": "#4d79ff",
		"terminal.ansiBrightRed": "#ff6166",
		"terminal.ansiBrightWhite": "#fafbfc",
		"terminal.ansiBrightYellow": "#ffea7f",
		"terminal.ansiCyan": "#39c5cf",
		"terminal.ansiGreen": "#34d058",
		"terminal.ansiMagenta": "#4d79ff",

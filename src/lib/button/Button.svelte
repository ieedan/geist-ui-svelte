...
{#if href != undefined}
	<a
		...
		data-[style='abort-active']:bg-transparent data-[style='abort-active']:dark:bg-transparent data-[style='abort-active']:hover:bg-transparent
		data-[style='abort-active']:hover:dark:bg-transparent data-[style='abort-active']:border-transparent data-[style='abort-active']:hover:dark:text-gray-0
		data-[style='abort-active']:text-gray-400 data-[style='abort-active']:dark:text-gray-600 data-[style='abort-active']:hover:text-gray-999 {className}"
	>
		{#if loading}
			<Loading
				size="sm"

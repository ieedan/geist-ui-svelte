...
<button
	...
	group-data-[color='primary']:text-gray-500 group-data-[color='primary']:dark:text-gray-500
  ...
  group-data-[color='primary']:aria-selected:dark:text-gray-999
	...
	group-data-[color='secondary']:text-gray-500 group-data-[color='secondary']:dark:text-gray-500"
>
	<slot />
</button>

...
{#if browserURL != undefined}
	<div
		...
		<div
            ...
            bg-gray-999 data-[invert=true]:bg-gray-0 data-[invert=true]:text-gray-999 text-gray-0 border-gray-900 data-[invert=true]:border-gray-100 font-light px-4">
			...
			<a
				href={browserURL}
				target="_blank"
				class="text-xs flex place-items-center gap-[2px] px-4 py-1 bg-gray-900 group-data-[invert=true]:bg-gray-100 rounded-sm">
				{#if isHttps}
					<LockIcon size={10} />
				{/if}
				{url}
